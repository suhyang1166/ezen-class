...
// Number() 가장 큰 개념 전부 숫자로 VS parseInt() 0숫자의 형태를 띄고 있는 애들을 정수로 바꿔줌  VS parseFloat() 소수점까지
...
// let num = null;
// console.log(typeof num.toString()); >> null은 못읽음
...
// const a = Number(prompt("화씨온도를 입력해주세요!"));
// const b = (a - 32) / 1.8;
// console.log(b);

// document.write(`섭씨온도는 ${b}입니다!`);
