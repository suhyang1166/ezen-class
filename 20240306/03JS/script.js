...
// 태생이 이터러블 객체가 아니더라도 이 요소들을 이터러블한 속성으로 변경시켜서 반복문을 사용할 수 있도록 하기위한 목적!
...
// console.log(arr);
// // 이터러블 하지 않은 객체 및 기타 요소들을 어떻게 하면 이터러블하게 만들 수 있을까?의 해결책을 찾기 위해서 이터러블 객체의 특징을 확인하고자 합니다!

// const arr01 = new Array();

// 배열, 이터러블한 객체가 되기 위해서 클래스 생성자 함수에는 심볼이 존재하는데, "Symbol.iterator" => 심볼함수가 존재하기 때문에 배열은 이터러블한 객채가 될 수 있음
